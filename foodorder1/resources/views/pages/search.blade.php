                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 mb-4 category-{{$item->categoryid}} categoryListing">
                                    <div class="card product-listing p-4" style="height: 450px;">
                                      ...
                                      <div class="card-body">
                                        ...
                                        <a href="{{ url('addcartsearch/'.$item->id.'/'.$name) }}"  class="product-action-btn btn text-white btn-rounded waves-effect waves-light orange darken-3 productClickAction"><i class="fas fa-plus-circle"></i> Add</a>
